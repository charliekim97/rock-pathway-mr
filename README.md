...
> *Human genetic de-prioritization of RhoA–ROCK expression: limits of expression-based
> validation for an intracellular kinase target.* Kim S. & Kim Y.-B. (manuscript; DOI on publication).
